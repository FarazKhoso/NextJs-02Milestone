...
<h1 className="text-white text-6xl max-w-[320px] mx-auto font-semibold my-12">
        Salected<span className="text-yellow-400">Projects</span>
      </h1>
        ...
        <div className=" px-6 md:px-0 max-w-[1000px] mx-auto mt-40 space-y-24">
            ...
            >
                ...
                <div className="flex justify-center items-center">
                   <a href="https://github.com/FarazKhoso/simple_calculator.git"> <Image src={project.src} alt={project.title} className="h-[350px] w-[500px] object-cover border rounded border-gray-700  transition-all duration-500 hover:shadow-[1px_1px_20px_#0ef,1px_1px_40px_#0ef] hover:scale-105" /> </a>
                </div>
