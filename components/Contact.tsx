      ...
      <div className="flex justify-center items-center">
        <ul className="space-y-4">
          <li className="flex items-center">
            ...
            <p className="text-xl">3124 534 6 75585</p>
          </li>

          <li className="flex items-center">
            <Image src={mail} alt="mail" className="h-[110px] w-auto mr-6" />
            <p className="text-xl">abc@123gmail.com</p>
          </li>
        </ul>
      </div>
        ...
        <form className="space-y-4" action="https:getfrom."  method="POST">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <input className="bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400" placeholder="Phone" type="phone" />
          </div>
